  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-md bg-white border border-slate-200/80 rounded-3xl shadow-2xl p-6 sm:p-8 overflow-hidden"
      >
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="h-16 w-16 bg-amber-50 border border-amber-100 rounded-2xl flex items-center justify-center mb-5 relative">
            <AlertTriangle className="h-8 w-8 text-amber-500 animate-pulse" />
            <span className="absolute -top-1 -right-1 h-3.5 w-3.5 rounded-full bg-amber-500 border-2 border-white" />
          </div>
          ...
          <div className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 px-6 flex items-center justify-between mb-6">
          ...
          <button
            onClick={onDismiss}
            className="w-full py-2.5 sm:py-3.5 px-4 sm:px-6 rounded-xl sm:rounded-2xl bg-amber-500 hover:bg-amber-600 active:bg-amber-700 text-white font-bold text-xs sm:text-sm shadow-lg shadow-amber-500/20 hover:shadow-amber-500/30 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer text-center"
          >
