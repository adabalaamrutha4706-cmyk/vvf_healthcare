...
export default function SOPTechnicianTherapiesHistory() {
  const { user } = useAuth();
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">
              <Link href="/sop-technician/therapies" className="hover:text-primary-green transition-colors flex items-center gap-1">
            ...
            <h1 className="text-lg sm:text-2xl font-bold text-slate-500 flex items-center gap-2">
              My SOP Audit Session History
              <Activity className="h-5 w-5 text-primary-green" />
            </h1>
            <p className="text-sm text-slate-400 mt-0.5">
              Permanent clinical log records for all your audited sessions.
            </p>
          </div>
