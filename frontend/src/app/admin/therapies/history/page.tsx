...
import { 
  ...
  CheckCircle, ShieldAlert, ArrowLeft, Filter, FileSpreadsheet
} from 'lucide-react';
import Link from 'next/link';

export default function AdminTherapiesHistory() {
  const { user } = useAuth();
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">
              <Link href="/admin/therapies" className="hover:text-primary-green transition-colors flex items-center gap-1">
            ...
            <h1 className="text-lg sm:text-2xl font-bold text-slate-500 flex items-center gap-2">
              Therapies Session History
              <Activity className="h-5 w-5 text-primary-green" />
            </h1>
            <p className="text-sm text-slate-400 mt-0.5">
              Permanent clinical log records for all medical and therapy modalities.
            </p>
          </div>
          ...
          <form onSubmit={handleSearchSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5 items-end">
            ...
            <div>
              ...
              >
                ...
                <option value="Hydrogen Inhalation">Hydrogen Inhalation</option>
