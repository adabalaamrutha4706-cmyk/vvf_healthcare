export const USER_PROFILE_SELECT =
  'id, name, email, role, phone, personal_email, age, date_of_birth, gender, about, is_active, created_at, photo_url, password_change_count, password_change_limit, password_change_locked, monthly_target';
